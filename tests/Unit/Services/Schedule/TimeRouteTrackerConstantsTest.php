...
class TimeRouteTrackerConstantsTest extends TestCase
{
    public function testStartTimeConstants(): void
    {
        $this->assertSame('9:00', TimeRouteTracker::START_TIME_STR);
    }

    public function testPercentRand(): void
    {
        $this->assertSame(['from' => 1, 'to' => 100], TimeRouteTracker::PERCENT_RAND);
    }

    public function testStartTimeRand(): void
    {
        $this->assertSame(['from' => 0, 'to' => 9], TimeRouteTracker::START_TIME_RAND);
    }

    public function testBlyMovingRand(): void
    {
        $this->assertSame(['from' => 8, 'to' => 18], TimeRouteTracker::BLY_MOVING_RAND);
    }

    public function testBetweenMovingRand(): void
    {
        $this->assertSame(['from' => 4, 'to' => 13], TimeRouteTracker::BETWEEN_MOVING_RAND);
    }

    public function testGoodWeatherCoeff(): void
    {
        $this->assertSame(['plus' => 1.1, 'minus' => 0.95], TimeRouteTracker::GOOD_WEATHER_FL_COEFF);
    }

    public function testBadWeatherCoeff(): void
    {
        $this->assertSame(['plus' => 1.05, 'minus' => 0.90], TimeRouteTracker::BAD_WEATHER_FL_COEFF);
    }

    public function testRoadSpeed(): void
    {
        $this->assertSame(['g' => 95, 'n' => 40, 'b' => 30], TimeRouteTracker::ROAD_SPEED);
    }
    ...
    public function testRoadSpeedCorrection(): void
    {
        ...
        $this->assertSame(TimeRouteTracker::ROAD_SPEED_CORRECTION, $expected);
    }
